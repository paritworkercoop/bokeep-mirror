...
setup(name='Bo-Keep',
      ...
      packages=[PACKAGE_NAME,
                PACKAGE_NAME + '.backend_modules',
                PACKAGE_NAME + '.gui',
                PACKAGE_NAME + 'gui.config',
                PACKAGE_NAME + '.gui.gladesupport',
                PACKAGE_NAME + '.modules',
                PACKAGE_NAME + '.modules.payroll',
                PACKAGE_NAME + '.modules.trust',
                PACKAGE_NAME + '.modules.trust.GUIs',
                PACKAGE_NAME + '.modules.trust.GUIs.entry',
                PACKAGE_NAME + '.modules.trust.GUIs.management',
                PACKAGE_NAME + '.modules.mileage',
                ]
