# Copyright (C) 2010-2015  ParIT Worker Co-operative, Ltd <paritinfo@parit.ca>
#
...
class Basic2015JanPayTest(TestCase):
    def setUp(self):
        self.emp = Employee("test employee")
        date_paydate_one = date(2015, 01, 01) # 2015, Jan, 1st
...
def create_basic_test_class(name, income, fed_tax_credits, prov_tax_credits,
    ...
    class new_test_class(Basic2015JanPayTest):
        def setUp(self):
            Basic2015JanPayTest.setUp(self)
...
TestMedIncome = create_basic_test_class('TestMedIncome', 740, 1, 1,
                                        '69.70', '29.97', '13.91')
TestMedIncome.test_income_tax_specific = make_fed_tester('32.46')
