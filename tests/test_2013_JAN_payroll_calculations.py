...
class Basic2013JanPayTest(TestCase):
    def setUp(self):
        self.emp = Employee("test employee")
        date_paydate_one = date(2013, 01, 01) # 2013, Jan, 1st
...
def create_basic_test_class(name, income, fed_tax_credits, prov_tax_credits,
    ...
    class new_test_class(Basic2013JanPayTest):
        def setUp(self):
            Basic2013JanPayTest.setUp(self)
