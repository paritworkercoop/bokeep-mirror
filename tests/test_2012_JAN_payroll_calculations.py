...
class Basic2012JanPayTest(TestCase):
    def setUp(self):
        self.emp = Employee("test employee")
        date_paydate_one = date(2012, 01, 01) # 2012, Jan, 1st
...
def create_basic_test_class(name, income, fed_tax_credits, prov_tax_credits,
    ...
    class new_test_class(Basic2012JanPayTest):
        def setUp(self):
            Basic2012JanPayTest.setUp(self)
...
# CRA says income tax of 125.59 but we'll live with a cent off for now
TestSuperMedIncome = create_basic_test_class('TestMedIncome', 950, 1, 1,
                                             '125.58', '40.36', '17.39')
