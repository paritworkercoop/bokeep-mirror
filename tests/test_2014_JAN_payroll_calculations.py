# Copyright (C) 2010-2014  ParIT Worker Co-operative, Ltd <paritinfo@parit.ca>
#
...
class Basic2014JanPayTest(TestCase):
    def setUp(self):
        self.emp = Employee("test employee")
        date_paydate_one = date(2014, 01, 01) # 2014, Jan, 1st
...
def create_basic_test_class(name, income, fed_tax_credits, prov_tax_credits,
    ...
    class new_test_class(Basic2014JanPayTest):
        def setUp(self):
            Basic2014JanPayTest.setUp(self)
...
TestMedIncome = create_basic_test_class('TestMedIncome', 740, 1, 1,
                                        '70.90', '29.97', '13.91')
TestMedIncome.test_income_tax_specific = make_fed_tester('33.66')
