...
There are only two transaction types, Trust Money In (trustee takes money from trustor) and Trust Money Out (trustee pays money out to or for the benefit of the trustor).
...
In the trust plugin configuration interface you can define the trustor. Enter a name in the name field and click on the "save" button to add it to the list on the left hand side. The "add" button mearly erases the name field, nothing more.
